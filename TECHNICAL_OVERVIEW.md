# Researcher-AI: Technical Overview

**As of March 16, 2026**

This document provides a clean, detailed technical and functional overview of the Researcher-AI codebase based directly on code inspection and E2E validation reports. It covers architecture, individual components, data flows, and operational status.
...
Researcher-AI is organized into **five strict layers**, each with clearly defined responsibilities and boundaries:
